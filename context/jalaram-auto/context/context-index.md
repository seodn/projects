...
- `product-marketing-context.md` - core positioning, audience, differentiators, objections, proof, voice, and conversion goals.
...
- `../research/meeting-transcript-notes-2026-08-04.md` - extracted notes from the referenced Digital Neighbour meeting transcript.
- Public references:
  - MTA member listing for Jalaram Auto: https://mta.org.nz/find-members/wof
  - Company Hub listing for Jalaram Auto Limited: https://www.companyhub.nz/companyDetails.cfm?nzbn=9429051725259

## Main Build Brief

- `../content/website-structure-and-keyword-map.md` - recommended SEO-focused site architecture, navigation, URL map, internal linking plan, and page priorities.
...
- Whether the website domain is existing, new, or being rebuilt under the current live domain.
