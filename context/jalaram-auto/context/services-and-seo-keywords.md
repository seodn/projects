...
- tyre repair Glen Eden
- MTA approved mechanic Glen Eden
...
- Position Jalaram Auto as the trusted local workshop and route visitors into the right service page quickly.
...
| Page | Primary keyword | Secondary keywords | Notes |
| --- | --- | --- | --- |
| `/mechanic-glen-eden` | mechanic Glen Eden | WOF Glen Eden, car service Glen Eden, car repairs Glen Eden | First local SEO priority. |
| `/mechanic-west-auckland` | mechanic West Auckland | WOF West Auckland, car service West Auckland, hybrid mechanic West Auckland | Broader service-area page. |
...
- Hybrid battery repair vs replacement: what West Auckland drivers should know.
- What happens if your car fails a WOF?
- Basic service vs full service: what is the difference?
- Can a tyre puncture be repaired?
- Why sidewall punctures cannot be repaired safely.
- What is brake and rotors skimming?
- When do you need cam belt replacement?
- What to know before approving an engine rebuild.
- How WINZ car repair quotes work.
- How Afterpay can help with eligible car repairs, if confirmed.
- What to bring for a WOF inspection.
- How MTA approval helps when choosing a mechanic.
- Why mechanics take photos of old parts before replacing them.

## Keyword Guardrails

- Do not target wheel alignment unless the client starts offering it.
- Do not lead with dent repair, panel beating, or bodywork.
- Do not overuse "cheap mechanic"; use fair, transparent, or starting-price language.
- Do not split every suburb into a location page at launch.
- Keep hybrid pages clear and plain for laypeople, not only technicians.
